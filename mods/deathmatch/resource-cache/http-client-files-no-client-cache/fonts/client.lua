...
local fontsSource = {
	...
	["project"] = "files/project.ttf",
	["project1"] = "files/project1.ttf",
	["FontAwesome6"] = "files/FontAwesome6.ttf",
	["inter"] = "files/inter.ttf",
}
